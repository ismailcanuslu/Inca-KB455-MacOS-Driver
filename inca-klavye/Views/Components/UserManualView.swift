    ...
    var body: some View {
        ScrollView(.vertical, showsIndicators: false) {
            VStack(spacing: 24) {
                ...
                // 1. Döner Tekerlek (Knob) Özel Kartı (ÖNE ÇIKAN)
                VStack(alignment: .leading, spacing: 14) {
                    HStack {
                        Image(systemName: "dial.medium.fill")
                            .font(.system(size: 18))
                            .foregroundColor(.pink)
                        Text(loc.tr("manual_knob_header", default: "DÖNER TEKERLEK (KNOB) ÇALIŞMA MANTIĞI"))
                            .font(.system(size: 12, weight: .bold))
                            .foregroundColor(.secondary)
                            .tracking(1.2)
                        Spacer()
                        Text(loc.tr("manual_knob_badge", default: "Donanımsal Geçiş"))
                            .font(.caption2)
                            .fontWeight(.bold)
                    ...
                    VStack(spacing: 10) {
                        manualActionRow(
                            combo: loc.tr("manual_knob_hold_combo", default: "3-5 Saniye Basılı Tutun"),
                            action: loc.tr("manual_knob_hold_action", default: "Ses & Medya Modu ⟷ RGB Parlaklık Modu"),
                            desc: loc.tr("manual_knob_hold_desc", default: "Tekerleğe dik şekilde 3-5 saniye basılı tuttuğunuzda klavye ışıkları 3 defa yanıp söner ve çalışma modunu değiştirir."),
                            badgeColor: .pink
                        )

                        manualActionRow(
                            combo: loc.tr("manual_knob_click_combo", default: "Tek Tık (Kısa Basış)"),
                        ...
                        manualActionRow(
                            combo: loc.tr("manual_knob_turn_combo", default: "Sağa / Sola Çevirme"),
                ...
                // 2. Sistem & Sıfırlama Kısayolları
                manualSectionCard(
                ...
                // 4. Bağlantı Modları (3-Modlu Bağlantı)
                manualSectionCard(
